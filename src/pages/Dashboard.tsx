...
const Dashboard = () => {
  ...
  const navigation = [
    ...
    { name: 'Projets', href: '/dashboard/projects', icon: LayoutDashboard },
          ...
          <div className="flex-shrink-0 flex border-t border-indigo-800 p-4 glass-effect">
            <div className="flex items-center w-full">
              <div className="relative">
                <img className="inline-block h-10 w-10 rounded-full ring-2 ring-white ring-opacity-30 transition-all hover:ring-opacity-50 hover:scale-105" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Profile" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="card-hover animate-on-load bg-white rounded-2xl p-6 modern-shadow border border-gray-100" style={{ animationDelay: '0.3s' }}>
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-sm font-medium text-gray-500">Rapports</p>
